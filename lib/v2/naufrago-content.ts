...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    category: "bebidas",
    name: "Cola grande",
    description: "Elige tu sabor preferido · 1 litro.",
    tags: [],
    priceUsd: 2.0,
    imageUrl: "/stories/cola-grande.jpg",
    emoji: "🥤",
  ...
  },
  {
    ...
    category: "bebidas",
    name: "Cola pequeña",
    description: "Elige tu sabor preferido · 350ml.",
    tags: [],
    priceUsd: 1.25,
    imageUrl: "/stories/cola-pequena.jpg",
    emoji: "🥤",
