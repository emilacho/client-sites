...
export async function handleSearchMenu(
  ...
  if (results.length === 0) {
    return {
      ...
      results: [],
      hint:
        "Ningún ítem matcheó · sugerile al cliente las opciones más populares (Encebollado Náufrago $4 · Ceviche Náufrago $7 · Patacones Náufrago $4) o pedile que reformule.",
    }
  }
