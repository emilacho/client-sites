...
function CofreSoundwaveFX({
  ...
  // R96.73 · onda 1 sincronizada exact con el impacto (t=0). Cofre
  // empieza a vibrar Y onda 1 nace en el mismo instante (impact-frame
  // de la gota). Ondas 2-4 nacen después por physics ripple natural.
  const RING_DELAYS = [0, 0.2, 0.4, 0.6]
...
function createPromoTexture(): THREE.CanvasTexture | null {
  ...
  // "5% DSCT" · 380 · purple · R96.91 · "5%" +30% (90→117) ·
  // "DSCT" stays 90 · split en dos lineAt para diferenciar tamaño.
  ...
  // Signature "El Náufrago" · R96.93 · Y=505 · centrado entre
  // "5% DSCT" (Y=380) y botón "Aplicar promo" (Y=580 top).
  ...
  // Sea-wave squiggle · debajo de la firma · R96.93
  ctx.strokeStyle = PURPLE_NF
  ctx.lineWidth = 3
  ctx.beginPath()
  ctx.moveTo(412, 545)
